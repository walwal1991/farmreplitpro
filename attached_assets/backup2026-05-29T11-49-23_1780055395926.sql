...
\restrict 9Fr0fKzUOQgpaWiSVUf1G1lUq3dVQR4dTnYAc02Y5ZKOD7VYHMXs6A5Sl8ZkGkr
...
--
-- Name: bio_waste_prices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bio_waste_prices (
    id integer NOT NULL,
...
--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bio_waste_prices_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bio_waste_prices_id_seq OWNED BY public.bio_waste_prices.id;


--
-- Name: bio_waste_purchases; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bio_waste_purchases (
    id integer NOT NULL,
    request_code character varying NOT NULL,
    customer_id integer,
    seller_name character varying NOT NULL,
    seller_phone character varying NOT NULL,
    wilaya character varying NOT NULL,
    address text NOT NULL,
    waste_type character varying DEFAULT 'food_scraps'::character varying NOT NULL,
    estimated_weight_kg numeric NOT NULL,
    price_per_kg numeric NOT NULL,
    total_payout numeric GENERATED ALWAYS AS ((estimated_weight_kg * price_per_kg)) STORED,
...
--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bio_waste_purchases_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bio_waste_purchases_id_seq OWNED BY public.bio_waste_purchases.id;
...
CREATE TABLE public.conversations (
    id integer NOT NULL,
    title text DEFAULT 'محادثة'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: delivery_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: delivery_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: delivery_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: delivery_users; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: delivery_users_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: delivery_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: bio_waste_prices id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_prices ALTER COLUMN id SET DEFAULT nextval('public.bio_waste_prices_id_seq'::regclass);


--
-- Name: bio_waste_purchases id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_purchases ALTER COLUMN id SET DEFAULT nextval('public.bio_waste_purchases_id_seq'::regclass);
...
--
-- Name: delivery_sessions id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: delivery_users id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices id; Type: DEFAULT; Schema: public; Owner: -
--
...
26	new_order	طلب جديد #65	abdo tejini — ksar el boukhari — 3150 د.ج	65	t	2026-05-06 10:07:48.66997+00
27	new_order	طلب جديد #66	wafa anifeg — medea — 3500 د.ج	66	t	2026-05-11 08:57:00.275958+00
28	new_order	طلب جديد #67	wafa anifeg — تمنراست — 950 د.ج	67	t	2026-05-11 08:59:00.384773+00
29	new_order	طلب جديد #68	wafa anifeg — blida — 1800 د.ج	68	t	2026-05-11 09:17:35.942973+00
33	new_order	طلب جديد #72	wafa anifeg — blida — 1400 د.ج	72	t	2026-05-11 09:35:24.28311+00
32	new_order	طلب جديد #71	wafa anifeg — blida — 1800 د.ج	71	t	2026-05-11 09:31:40.453132+00
31	new_order	طلب جديد #70	wafa anifeg — blida — 1800 د.ج	70	t	2026-05-11 09:22:19.431891+00
30	new_order	طلب جديد #69	wafa anifeg — blida — 1800 د.ج	69	t	2026-05-11 09:22:07.208324+00
34	new_order	طلب جديد #78	adam anifak — ksar el boukhari — 750 د.ج	78	t	2026-05-18 09:03:00.750112+00
35	new_order	طلب جديد #79	adam anifak — ksar el boukhari — 1800 د.ج	79	t	2026-05-18 09:16:26.792009+00
36	new_order	طلب جديد #80	adam anifak — ksar el boukhari — 712 د.ج	80	t	2026-05-18 09:26:48.722515+00
\.
...
207	f2bc87f76d58338efa86fd42ff3a0d0526ae367f3570f4d4e49f160e9a3683bb	admin	2026-05-10 12:10:06.914936+00	2026-06-09 12:10:06.913+00
208	0e70c9b40b6d54f81208056191e0a2ca59273fe6474f66eec7dc305a1ac10b60	admin	2026-05-10 12:11:47.874496+00	2026-06-09 12:11:47.873+00
209	6cde5a4651e42d23fe4e65372d2e063ecf849e8f6b8085657f6a62d5f1589fa1	admin	2026-05-10 12:18:14.046366+00	2026-06-09 12:18:14.045+00
210	23d9bf3dbac4a49ce0496586df1367089df4852ce3fbdc0706e5289af0c747f7	admin	2026-05-11 08:54:04.393488+00	2026-06-10 08:54:04.392+00
211	ae848cf3c4a46ca940d0b869ed12e70ba8a3eed42a6cde2e5260d24236f2fc43	admin	2026-05-11 08:57:29.60375+00	2026-06-10 08:57:29.603+00
212	4d1c094c558b8311aded5bf7b68a9a96a6cb3f970f0d964574b63e90b419b265	admin	2026-05-11 08:59:36.732505+00	2026-06-10 08:59:36.731+00
213	87f0b16215f93fbcf5ea6af94bdfab2d497a9679f9c0824539e9b11289977680	admin	2026-05-11 09:21:34.611148+00	2026-06-10 09:21:34.609+00
214	59969286ac788ac5a293781ce66717b571e7adea07600428e0cbcb9cbea6eefb	admin	2026-05-11 09:36:39.558839+00	2026-06-10 09:36:39.557+00
215	9189c864077bd9ba44e1e5fb0812887bef58160cda1802ab8c92fe3b116e45e6	admin	2026-05-11 09:41:24.051294+00	2026-06-10 09:41:24.05+00
216	a10f6b402dbf3819fee30a59d2d688bc9b809fbc77620cdde9138d4237fb2755	admin	2026-05-11 11:12:01.855277+00	2026-06-10 11:12:01.854+00
217	2f15b983fc9457dd1b4afdbba62bc58710a3881a5023624a7cd3fd6c7e9fa597	admin	2026-05-11 11:19:36.516687+00	2026-06-10 11:19:36.515+00
218	b9ec9d1c31a18af00a27ee5bceffcf7f0d22262b4e32c383b341469a220e9585	admin	2026-05-12 08:44:18.539386+00	2026-06-11 08:44:18.538+00
219	aff9916ec096efd51cbd0920aefeb81b73f0f97f1ce308a5b9dcec3cdd74e03e	admin	2026-05-12 08:45:41.661156+00	2026-06-11 08:45:41.66+00
220	d8f21e2f4ce1a6e98f7e0a9958d864f93962b38bb1285f105d9f2d6afac1f2c6	admin	2026-05-12 08:50:28.749977+00	2026-06-11 08:50:28.748+00
221	84a01f8ed28eb6da362bdddfbb4faf6bc35c87d37c6c59c6a011f9464fda4ac8	admin	2026-05-13 10:32:27.507291+00	2026-06-12 10:32:27.506+00
222	da4f9e8b32406a7bd08641395c4511240f1c9890968abeb49ee1e83c843a7719	admin	2026-05-13 10:39:37.167362+00	2026-06-12 10:39:37.166+00
223	e0d7056f53546143cd64e70a2cdbc3a09578cf9ea6dd8a42ab320ed4e7a500dd	admin	2026-05-13 10:39:51.642143+00	2026-06-12 10:39:51.641+00
224	b8d6805b679f96674859bf8595d0063774314a362235236975e7258ce5e26384	admin	2026-05-13 10:43:57.037878+00	2026-06-12 10:43:57.036+00
225	02872807f45a4c02c2fe5fb843b17ca8e47209c6c9c6986f2f54c1f98ddde5c9	admin	2026-05-13 10:45:33.93261+00	2026-06-12 10:45:33.931+00
226	16206e5fd361043cf1bd1f38e1b2b70b4479af94b29a8103d24a286f8a5cd9ba	admin	2026-05-13 10:53:25.519194+00	2026-06-12 10:53:25.518+00
227	da3e975b1aced5aafbb5519b9e0cd3232552af23b9bd715f896b10bcaee36604	admin	2026-05-13 10:59:22.842576+00	2026-06-12 10:59:22.841+00
228	efeb26d38acea060623551584a001e8d5b17702d1ada7f5bf577329229332318	admin	2026-05-13 10:59:31.079895+00	2026-06-12 10:59:31.079+00
229	bc12fccd0b5623aed5728e99f176e40dbd81a656f2197dcd60daec9ed5b2fb30	admin	2026-05-18 08:45:07.17947+00	2026-06-17 08:45:07.178+00
230	11f991c5fd160e8064e14fa88edea463ee9ccc5c1fa2ce8ad365fc8dee8a570e	admin	2026-05-18 08:55:23.184516+00	2026-06-17 08:55:23.183+00
231	8c21ba34c7796aeac5a38e186050a42d16030725da91f74feb139c45900a8c5c	admin	2026-05-18 08:58:41.272176+00	2026-06-17 08:58:41.271+00
232	0606e0f6911a9cce0cf8cd5420721edebae9590787173cc97df713987edefce0	admin	2026-05-18 08:59:30.814765+00	2026-06-17 08:59:30.814+00
233	df1b887247d4d71b451301411bfa824a4c0e7992276dced7d5a8d5238774924a	admin	2026-05-18 08:59:57.910344+00	2026-06-17 08:59:57.909+00
234	9d7d5ad3ce10e22a6b80f8f1bd829e0e555faa997bd310f48db7a885533d335d	admin	2026-05-18 09:01:56.612867+00	2026-06-17 09:01:56.612+00
235	b499e9ef97f6d30026c70a62b84de0306d9b5896d758b97fb0d072282e886c09	admin	2026-05-18 09:03:34.191751+00	2026-06-17 09:03:34.191+00
236	fec54ceef229067771edccc3adbdddb490e8426e3962d027ab4c32e488e848b8	admin	2026-05-18 09:16:57.156425+00	2026-06-17 09:16:57.155+00
237	f44a864c2a3f65219f31f5d2e0022b2988e3765dc41487161d53278ce64cff00	admin	2026-05-18 09:27:40.72748+00	2026-06-17 09:27:40.726+00
238	e467f0ad742076322a6d5801964f44b45b23afb4738a3c4b897220898efbf0ac	admin	2026-05-18 09:29:22.211172+00	2026-06-17 09:29:22.21+00
239	637548b6ab42add85ba3a66a92c925b4f500f2bcbf5f2bf9d9710b6a869c4993	admin	2026-05-18 09:42:56.707441+00	2026-06-17 09:42:56.706+00
240	4b12f41478318476f81619d99502e58a76f4d180e42c7460ff993f636043f6f4	admin	2026-05-19 13:57:51.758493+00	2026-06-18 13:57:51.757+00
241	4c9090d4a6bb2259608166be182b9040b12e0e775a1da9de11044ebad7bcef6f	admin	2026-05-23 15:30:11.70916+00	2026-06-22 15:30:11.708+00
242	1204377ca1d3c49ae270014ce0e9fbacf3bf485c0a1ee65e35bde628fb46f18b	admin	2026-05-23 15:57:48.803088+00	2026-06-22 15:57:48.801+00
243	dd3fb86a25e0e51bda2f2c695e5fb16bc2a1a182f4cef076ab654107de1325b1	admin	2026-05-23 16:01:46.535912+00	2026-06-22 16:01:46.535+00
244	8e9b665e9cc5967cc4705758d271a6296ad88f5171871d896fa6b721c2f9fb61	admin	2026-05-23 16:11:51.088848+00	2026-06-22 16:11:51.087+00
245	78baea981e30ad546520133c5500c40dd4a5c6e135a759b3701d708d5daaef33	admin	2026-05-23 16:22:18.643853+00	2026-06-22 16:22:18.643+00
246	e1907bbb7753ed8535c27809934f8f37da0d117e323ade39246933cd5c9e85c2	admin	2026-05-23 19:58:26.714638+00	2026-06-22 19:58:26.714+00
247	79c28c7e79dc3a373e61bed758ef7b010712f495c564b0a398c47fba476108fe	admin	2026-05-24 08:26:47.870141+00	2026-06-23 08:26:47.868+00
248	1dedeb004e3a0cbe9cb5ada699a756c33826e2b2661cc2c609393e7a3c22c15d	admin	2026-05-24 08:45:12.719075+00	2026-06-23 08:45:12.718+00
249	8d318d9d4df07f5c7823db0848f7230e5ffcfb430ae0b818f029e3f50653967b	admin	2026-05-24 08:47:24.672063+00	2026-06-23 08:47:24.671+00
250	db517165635fec3f5e438c7bc60c2b7c9ed7b66b4a42d8bfb56e8f7b9ae52f79	admin	2026-05-24 09:52:58.694161+00	2026-06-23 09:52:58.693+00
251	ef45dd799e7e61c408079071ed0f2e1cf81c94aac83514ac270afee5c717f0b4	admin	2026-05-25 08:23:42.446196+00	2026-06-24 08:23:42.445+00
252	4589f114d8b40aeaacdf85c18eef7e9e7b7ec443cda944483dc0f033af213b85	admin	2026-05-29 11:28:43.455561+00	2026-06-28 11:28:43.454+00
253	59931cb621d15b07203c0594c1782f70d554286edae5772d9ab34affef27ca95	admin	2026-05-29 11:49:13.008388+00	2026-06-28 11:49:13.007+00
\.
...
--
-- Data for Name: bio_waste_prices; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.bio_waste_prices (id, waste_type, label_ar, price_per_kg, updated_at) FROM stdin;
1	food_scraps	بقايا طعام	5	2026-05-12 08:36:15.855155+00
2	fruit_veg_peels	قشور الفواكه والخضار	8	2026-05-12 08:36:15.855155+00
3	agricultural_residue	مخلفات زراعية	3	2026-05-12 08:36:15.855155+00
4	cardboard_paper	كرتون وورق	4	2026-05-12 08:36:15.855155+00
5	coffee_grounds	تفل القهوة	10	2026-05-12 08:36:15.855155+00
6	manure	روث حيواني	6	2026-05-12 08:36:15.855155+00
7	mixed	مختلطة	4	2026-05-12 08:36:15.855155+00
\.


--
-- Data for Name: bio_waste_purchases; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.bio_waste_purchases (id, request_code, customer_id, seller_name, seller_phone, wilaya, address, waste_type, estimated_weight_kg, price_per_kg, actual_weight_kg, actual_payout, status, pickup_date, collected_date, payment_method, payment_status, notes, admin_notes, created_at) FROM stdin;
1	BW-URW78T	4	bilal boussaadi	0657613345	المدية	ksar el boukhari cite belkhirat mansour 	fruit_veg_peels	10	8	\N	\N	pending	\N	\N	bank_transfer	unpaid		\N	2026-05-12 08:43:36.197222+00
2	BW-YYVPAK	4	bilal boussaadi	0657613345	المدية	zobra	manure	20	6	\N	\N	pending	\N	\N	bank_transfer	unpaid		\N	2026-05-12 08:50:19.697716+00
3	BW-1U4EM3	\N	kamal yagoub	76875767575757	البليدة	bni marad	manure	49	6	\N	\N	pending	\N	\N	bank_transfer	unpaid		\N	2026-05-13 10:45:07.010027+00
4	BW-5VLN1G	\N	walid anifak	46464646464	المدية	ksar el boukhari sorecsud	fruit_veg_peels	50	8	\N	\N	approved	2026-05-18	2026-05-19	bank_transfer	unpaid			2026-05-18 08:44:48.628899+00
5	BW-GR3TTY	9	adam anifak	6757557757657	بشار	cite 5000	fruit_veg_peels	50	8	\N	\N	approved	2026-05-19	2026-05-20	cash	unpaid	thank you 		2026-05-19 13:57:38.365876+00
\.
...
COPY public.consultations (id, customer_name, phone, soil_type, crop, problem, status, created_at, image_url) FROM stdin;
1	anifeg wafa	0658749317	sandy	طماطم	جفاف التربة	new	2026-04-23 15:31:10.783783+00	\N
2	mimi nouredin	765765747647	sandy	طماطم	htffhgffhfhhgfhgfhfh	new	2026-04-27 09:29:33.790817+00	\N
3	walid anifak	0658749317	silt	طماطم	dgdgfgdfgdgdfgfgdfgddf	new	2026-05-06 08:51:31.686445+00	\N
\.
...
1	محادثة الدعم	2026-05-11 10:01:28.040724+00
2	محادثة الدعم	2026-05-11 11:08:17.810409+00
\.
...
8	walid anifak	0670206444	beginner	new	2026-05-24 08:44:51.478012+00	\N	\N
\.
...
63	4	5979b952971c6497d9ffe8c8aef53299d8f70697210ed38c250e5b73a6d06a11	2026-06-10 11:12:26.965+00	2026-05-11 11:12:26.965854+00
64	9	cfde5cef99a99ecc5df519ff03a001340583a3a358c60faa0839a0f924e373b9	2026-06-17 08:47:42.509+00	2026-05-18 08:47:42.510052+00
66	9	e8cb5083adebdae51331e786e9e742c065c661e1838a079332f6b9dcbb4f6ab7	2026-06-17 09:11:24.145+00	2026-05-18 09:11:24.145574+00
67	3	ed65d0b5c8f9826bbf5905e1f2eaa15bafece6e39c8e23d6905960ce5ba8ed6d	2026-06-24 08:53:37.63+00	2026-05-25 08:53:37.63158+00
\.
...
9	adam anifak	adam2027@gmail.com	6757557757657	$2b$10$n.n2pxBRThHnfV9RP9i5.e7tjSXe6vS/1XKizoz7m7umCWBJ24.MK	2026-05-18 08:47:42.500881+00	f	REF39616461	\N
10	nacira anifeg	nacira@gmail.com	656465464654	$2b$10$rrYL6yoR3hHsPjxkdX9lSuxs1JkOzqsM6qIoFM35EO82u92U/lF0m	2026-05-18 09:10:45.445598+00	f	REF31306E61	\N
\.


--
-- Data for Name: delivery_sessions; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: delivery_users; Type: TABLE DATA; Schema: public; Owner: -
--
...
14	\N	WELCOME-58E3A792	10	0	f	\N	2026-05-18 09:10:45.483782+00	10	referral_joinee	2026-07-17 09:10:45.483+00
15	\N	FRIEND-6E050AD3	15	0	t	2026-05-18 09:26:48.712972+00	2026-05-18 09:10:45.487235+00	9	referral_referrer	2026-07-17 09:10:45.487+00
13	\N	REV-20227F46	10	0	t	2026-05-18 09:26:48.716938+00	2026-05-18 09:09:20.147812+00	9	review_reward	2026-06-17 09:09:20.147+00
\.


--
-- Data for Name: donor_sessions; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: fertilizer_batches; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	1	user	كم مدة التوصيل؟	2026-05-11 10:01:29.232749+00
2	1	assistant	⏱️ مدة التوصيل تعتمد على موقعك، لكن تقريبًا كالتالي:\n\n- داخل نفس المدينة: من 1 إلى 3 أيام عمل  \n- بين المدن: من 3 إلى 5 أيام عمل  \n\nبعد تأكيد الطلب نرسل لك رقم تتبع 📦 عبر الواتساب أو البريد، وتقدر تتابع طلبك في أي وقت من خلال نظام تتبع الطلبات لدينا.  \nلو حاب، أعطني مدينتك وأعطيك تقديرًا أدق لوقت التوصيل 🚚	2026-05-11 10:01:32.074808+00
3	1	user	the delivery is free ?	2026-05-11 10:02:31.819218+00
4	1	assistant	حاليًا:  \n- داخل المدينة (ضمن نطاق التوصيل المعتمد): غالبًا التوصيل يكون منخفض التكلفة، وأحيانًا مجاني عند عروض أو عند تجاوز مبلغ معين 💸  \n- بين المدن: تكون هناك رسوم توصيل حسب شركة الشحن والمسافة 🚚  \n\nلأن الأنظمة والعروض تختلف حسب الفترة والمنطقة، أفضل شيء ترسل لي مدينتك وقيمة طلبك المتوقعة، وأقول لك بالضبط:  \n- هل التوصيل مجاني لك أم لا  \n- أو كم تقريبًا رسوم التوصيل 🎯	2026-05-11 10:02:34.686537+00
5	1	user	how much	2026-05-11 10:02:54.865578+00
6	1	assistant	رسوم التوصيل تعتمد على:  \n1️⃣ مدينتك  \n2️⃣ قيمة طلبك (أحيانًا التوصيل يكون مجاني إذا تعديت مبلغ معيّن)  \n\nبدون هذه المعلومات ما أقدر أعطيك رقم دقيق 💸  \nاكتب لي:  \n- مدينتك  \n- تقريبًا كم قيمة الطلب  \n\nوأقول لك تقدير رسوم التوصيل، وهل ممكن يكون مجاني في حالتك أو لا 🚚✨	2026-05-11 10:02:57.44656+00
7	2	user	بمادا يتميز هدا السماد	2026-05-11 11:08:18.400714+00
8	2	assistant	سماد الديدان (الدبال) يتميز بعدّة نقاط مهمة 👇  \n\n1️⃣ **طبيعي 100%**  \nبدون مواد كيميائية، آمن للنبات، للتربة، وللإنسان.  \n\n2️⃣ **يغذي التربة قبل النبات**  \nيزيد من خصوبة التربة، ويحسّن بنيتها وقدرتها على الاحتفاظ بالماء، فيقلّ الري.  \n\n3️⃣ **غني بالكائنات الحية النافعة**  \nيحتوي على بكتيريا وفطريات مفيدة تساعد جذور النبات على امتصاص العناصر بشكل أفضل.  \n\n4️⃣ **يُقوّي مناعة النبات**  \nيساعد النبات على مقاومة الأمراض والإجهاد (حرارة، برودة، نقل… إلخ).  \n\n5️⃣ **نتائج ملحوظة على النمو**  \nنمو أسرع، أوراق أكثر خضرة، ومحاصيل ذات جودة أفضل وطعم أحلى خصوصاً للخضروات والفواكه 🥬🍅  \n\nإذا حاب أشرح لك فرق السائل عن الصلب، أو أيهم أنسب لنباتاتك، قلّي نوع النباتات اللي عندك 🌱	2026-05-11 11:08:24.285472+00
9	2	user	هل يعدل درجة الحموضة و نسبة الملوحة	2026-05-11 11:09:55.168763+00
10	2	assistant	نعم، سماد الديدان يساعد بشكل كبير في **تحسين pH التربة** و**التقليل من أثر الملوحة** 👍  \n\n🔹 **بالنسبة للحموضة (pH):**  \n- الدبال من سماد الديدان يكون غالبًا قريب من المتعادل.  \n- يعمل كـ"منظّم طبيعي" للحموضة، يعني:\n  - إذا كانت التربة حامضية جدًا، يساعد على تقليل الحموضة تدريجيًا.  \n  - إذا كانت قلوية جدًا، يخفّف من الأثر ويجعل الوسط أنسب للنبات.  \n\n🔹 **بالنسبة للملوحة:**  \n- يزيد من **المادة العضوية** في التربة، وهذا:\n  - يحسّن بنية التربة وتصريف الأملاح الزائدة.  \n  - يساعد الجذور على تحمل الملوحة بشكل أفضل.  \n- استخدامه بشكل منتظم يقلل من مشاكل ملوحة التربة مع الوقت، خصوصًا مع ريّ مناسب.  \n\nلو حاب، نقدر نعمل لك **تشخيص ذكي للتربة**:  \nتعطينا نوع التربة، مصدر الماء (بئر، شبكة…)، والنباتات اللي تزرعها، ونرشّح لك أفضل منتج (سائل أو صلب) وطريقة استخدامه بالتفصيل 🌱💧	2026-05-11 11:10:01.182811+00
\.
...
67	wafa anifeg	4327635475247527	sorecsud 500 log	تمنراست		\N	كوكوبيت (ألياف جوز الهند) - كيس 5 كجم ×1	950	1	950	pending	2026-05-11 08:59:00.378876+00	\N	\N	VF2026F4B3BB	6	f	\N	\N	\N	\N	0	online	\N	pending	\N	[{"productId":25,"productName":"كوكوبيت (ألياف جوز الهند) - كيس 5 كجم","unitPrice":950,"quantity":1,"lineTotal":950}]
72	wafa anifeg	4327635475247527	ksar el boukhari	blida		\N	ديدان كاليفورنيا الحمراء - 250 غ ×1	1400	1	1400	confirmed	2026-05-11 09:35:24.266432+00	\N	\N	VF20267F9D7D	6	f	\N	\N	\N	\N	0	online	01krb68bn6nn55ns7tc32ch50m	paid	\N	[{"productId":15,"productName":"ديدان كاليفورنيا الحمراء - 250 غ","unitPrice":1400,"quantity":1,"lineTotal":1400}]
73	wafa anifeg	4327635475247527	500 log	البليدة	اشتراك سنوي #11 | المحصول: الطماطم	\N	صندوق الفلاح — سنوي — ماي 2026	45000	1	45000	confirmed	2026-05-11 09:36:24.431847+00	\N	\N	VF2026DB5E8643	6	f	\N	\N	\N	\N	0	online	\N	paid	11	\N
74	wafa anifeg	4327635475247527	zobra	أم البواقي	اشتراك سنوي #12 | المحصول: الطماطم	\N	صندوق الخبير — سنوي — ماي 2026	80000	1	80000	confirmed	2026-05-11 09:43:11.017641+00	\N	\N	VF20269F39EAE8	6	f	\N	\N	\N	\N	0	online	\N	paid	12	\N
75	bilal boussaadi	0657613345	cite 3500	بسكرة	اشتراك سنوي #13 | المحصول: الفلفل	\N	صندوق الخبير — سنوي — ماي 2026	80000	1	80000	confirmed	2026-05-11 11:19:23.907088+00	\N	\N	VF2026CD19BE6C	4	f	\N	\N	\N	\N	0	online	\N	paid	13	\N
76	adam anifak	6757557757657	zobra lycee boudiaf	البليدة	اشتراك شهري #15 | المحصول: البطيخ	\N	صندوق الفلاح — ماي 2026	4500	1	4500	confirmed	2026-05-18 08:54:58.7213+00	\N	\N	VF2026836F40FE	9	f	\N	\N	\N	\N	0	online	\N	paid	15	\N
77	adam anifak	6757557757657	hgfhfhgfhfhfhf	بشار	اشتراك سنوي #16 | المحصول: الجزر	\N	صندوق الفلاح — سنوي — ماي 2026	45000	1	45000	confirmed	2026-05-18 08:59:21.339068+00	\N	\N	VF202661383B77	9	f	\N	\N	\N	\N	0	online	\N	paid	16	\N
78	adam anifak	6757557757657	zobra cite 4599	ksar el boukhari		\N	بيرليت زراعي - كيس 5 لتر ×1	750	1	750	confirmed	2026-05-18 09:03:00.706761+00	\N	\N	VF202670A7E0	9	t	\N	\N	\N	\N	0	online	01krx562ffad1ejdhj945ywmz4	paid	\N	[{"productId":26,"productName":"بيرليت زراعي - كيس 5 لتر","unitPrice":750,"quantity":1,"lineTotal":750}]
79	adam anifak	6757557757657	zobra cite 4599	ksar el boukhari		\N	تربة زراعية عضوية محسّنة - كيس 20 كجم ×1	1800	1	1800	confirmed	2026-05-18 09:16:26.756243+00	\N	\N	VF2026711588	9	f	\N	\N	\N	\N	0	online	01krx5ynm4qqvx6ch8nq5ptvmd	paid	\N	[{"productId":27,"productName":"تربة زراعية عضوية محسّنة - كيس 20 كجم","unitPrice":1800,"quantity":1,"lineTotal":1800}]
80	adam anifak	6757557757657	zobra cite 4599	ksar el boukhari		\N	كوكوبيت (ألياف جوز الهند) - كيس 5 كجم ×1	712	1	712	confirmed	2026-05-18 09:26:48.677342+00	\N	\N	VF20264392F7	9	f	\N	\N	\N	FRIEND-6E050AD3,REV-20227F46	238	online	01krx6hn0vpv7b5sz6qwdq2sk4	paid	\N	[{"productId":25,"productName":"كوكوبيت (ألياف جوز الهند) - كيس 5 كجم","unitPrice":950,"quantity":1,"lineTotal":950}]
\.
...
11	25	9	adam anifak	5	good quality	2026-05-18 09:09:19.935846+00	\N
\.
...
1	سماد ديدان عضوي - كيس 5 كجم	سماد ديدان (Vermicompost) عضوي 100% غني بالعناصر الغذائية والميكروبات النافعة. مثالي للخضروات، الأشجار المثمرة والنباتات المنزلية. يحسن خصوبة التربة ويزيد المحصول دون مواد كيميائية.	1200	كيس	5	/img/solid-5kg.png	50	t	2026-04-23 14:57:16.119126+00	solid
6	بيو باور	مادة مساعدة أنيونية	750	لتر	0.5	/uploads/4ee842a09e50161d5e7d2fef.jpg	94	t	2026-04-24 11:13:42.268865+00	liquid
2	شاي الديدان السائل - 1 لتر	سماد سائل مركّز مستخرج من سماد الديدان، يُخفف بالماء ويُرش على الأوراق أو يُسقى عند الجذور لنتائج فورية. ممتاز للنباتات الضعيفة والشتلات.	800	لتر	1	/img/liquid-tea-1l.png	30	t	2026-04-23 14:57:16.119126+00	liquid
3	سماد ديدان فاخر - كيس 10 كجم	كيس عائلي بحجم اقتصادي، نفس الجودة العالية، يكفي لحديقة منزلية كاملة أو حقل صغير. تعبئة محكمة وسهلة التخزين.	2200	كيس	10	/img/solid-10kg.png	25	t	2026-04-23 14:57:16.119126+00	solid
16	ديدان كاليفورنيا الحمراء - 500 غ	كمية متوسطة مناسبة لمن يملك حاوية تسميد أو يريد تعزيز مزرعة قائمة. الديدان حية ونشيطة، قادرة على معالجة حتى 500 غ من المخلفات الغذائية يومياً.	2500	علبة	0.5	/img/worms-500g.png	29	t	2026-05-04 09:04:44.333813+00	worms
17	ديدان كاليفورنيا الحمراء - 1 كجم	الكمية المثلى لإطلاق مشروع سماد احترافي أو للمزارعين الراغبين في إنتاج السماد بكميات كبيرة. مناسبة لحوض بمساحة 60×40 سم على الأقل.	4500	علبة	1	/img/worms-1kg.png	19	t	2026-05-04 09:04:44.333813+00	worms
19	سماد ديدان للأشجار المثمرة - كيس 25 كجم	تركيبة مخصصة لأشجار الزيتون والحمضيات والنخيل وكل الأشجار المثمرة. مُعزَّز بالبوتاسيوم والفوسفور الطبيعيين لتعزيز الإثمار وتحسين جودة المحصول. الحجم المناسب للمزارع الصغيرة والمتوسطة.	4800	كيس	25	/img/solid-25kg.png	15	t	2026-05-04 09:04:44.333813+00	solid
20	سماد ديدان حبيبي - كيس 5 كجم	سماد ديدان مكبوس على شكل حبيبات سهلة التوزيع والتخزين. لا يسبب حرق الجذور، يناسب كل أنواع التربة الجزائرية (الطينية والرملية والكلسية). مثالي للخضروات الصيفية والبطاطا.	1500	كيس	5	/img/solid-5kg.png	40	t	2026-05-04 09:04:44.333813+00	solid
22	هيوميك أسيد سائل مركّز - 1 لتر	مستخرج طبيعي من سماد الديدان الناضج. يُحسّن استيعاب التربة للعناصر الغذائية ويُعزّز نمو الجذور والمقاومة للجفاف — مهم جداً في المناخ الجزائري الجاف. يُستخدم 2-5 مل لكل لتر ماء.	1100	قارورة	\N	/img/liquid-humic-1l.png	30	t	2026-05-04 09:04:44.333813+00	liquid
23	طقم بداية تربية الديدان المنزلية	كل ما تحتاجه في علبة واحدة: حاوية تهوية + 250 غ ديدان كاليفورنيا حية + فراش ليفي جاهز + دليل عربي مفصّل خطوة بخطوة. الهدية المثالية لعشاق الزراعة العضوية.	3200	طقم	\N	/img/kit-starter.png	20	t	2026-05-04 09:04:44.333813+00	kit
24	حاوية التسميد الحيوي - 40 لتر	حاوية تسميد منزلية من البلاستيك المعاد تدويره، مزوّدة بمنافذ تهوية وصنبور لتصريف السائل. سعة 40 لتر كافية لأسرة متوسطة (4-6 أفراد). سهلة التركيب والتنظيف، مقاومة للحرارة.	2800	حاوية	\N	/img/kit-bin-40l.png	15	t	2026-05-04 09:04:44.333813+00	kit
18	سماد ديدان عضوي - عبوة 1 كجم	العبوة الأصغر لعشاق النباتات المنزلية والشرفات. سماد ديدان 100% عضوي خالٍ من أي مواد كيميائية، غني بالبكتيريا النافعة والهيوميك أسيد. يكفي لـ 5-8 أصص كبيرة.	400	كيس	1	/img/solid-1kg.png	8	t	2026-05-04 09:04:44.333813+00	solid
15	ديدان كاليفورنيا الحمراء - 250 غ	ديدان Eisenia fetida الحمراء النشيطة، مثالية للبدء في مشروع السماد المنزلي. تتكاثر بسرعة وتحوّل المخلفات العضوية إلى سماد عالي الجودة خلال أسابيع. تُشحن في علبة معبأة بتربة رطبة.	1400	علبة	0.25	/img/worms-250g.png	49	t	2026-05-04 09:04:44.333813+00	worms
21	شاي الديدان المركّز - 5 لتر	عبوة اقتصادية لأصحاب الحدائق والمزارعين. يُخفف 1/10 بالماء ويُستخدم رشاً أو سقياً. يُنشّط الحياة الميكروبية في التربة ويُقوّي مناعة النبات ضد الأمراض والآفات.	3500	قارورة	\N	/img/liquid-tea-5l.png	13	t	2026-05-04 09:04:44.333813+00	liquid
26	بيرليت زراعي - كيس 5 لتر	حبيبات بيرليت خفيفة الوزن تُضاف للتربة لتحسين التصريف ومنع الاختناق الجذري. ضرورية لخلطات الشتلات وتربة حاويات الديدان. لا تغير درجة الحموضة، آمنة وطبيعية.	750	كيس	\N	/img/perlite.png	48	t	2026-05-04 09:04:44.333813+00	substrate
27	تربة زراعية عضوية محسّنة - كيس 20 كجم	خلطة احترافية جاهزة للاستخدام: تربة طبيعية + سماد ديدان + كوكوبيت + بيرليت. pH محايد (6.5-7). مثالية للأصص والأحواض والخضروات المنزلية. مُعقَّمة وخالية من بذور الحشائش والآفات.	1800	كيس	20	/img/enriched-soil.png	20	t	2026-05-04 09:04:44.333813+00	substrate
25	كوكوبيت (ألياف جوز الهند) - كيس 5 كجم	وسيط زراعي طبيعي مستخرج من قشر جوز الهند. يُستخدم فراشاً للديدان أو خلطاً مع التربة لتحسين التهوية والاحتفاظ بالماء. شائع في البيوت المحمية والزراعة المائية (Hydroponie).	950	كيس	5	/img/coco-coir.png	33	t	2026-05-04 09:04:44.333813+00	substrate
\.


--
-- Data for Name: sensor_devices; Type: TABLE DATA; Schema: public; Owner: -
--
...
11	11	ماي 2026	preparing	VF2026DB5E8643	\N	\N	\N	2026-05-11 09:36:24.42503+00
12	12	ماي 2026	preparing	VF20269F39EAE8	\N	\N	\N	2026-05-11 09:43:11.012721+00
13	13	ماي 2026	preparing	VF2026CD19BE6C	\N	\N	\N	2026-05-11 11:19:23.902609+00
14	15	ماي 2026	preparing	VF2026836F40FE	\N	\N	\N	2026-05-18 08:54:58.716204+00
15	16	ماي 2026	preparing	VF202661383B77	\N	\N	\N	2026-05-18 08:59:21.333826+00
\.
...
COPY public.subscription_plans (id, name, name_ar, name_fr, description, description_ar, description_fr, price_per_month, fertilizer_kg, includes_tips, includes_plan, includes_consultation, color, active, created_at, billing_cycle) FROM stdin;
1	Green Box	الصندوق الأخضر	La Boîte Verte	Starter monthly box with organic worm castings and farming tips	صندوق شهري يحتوي على 5 لتر من السماد السائل العضوي لمحصولك	Boîte mensuelle pour débutants: engrais lombricompost + conseils agricoles	2500	5	t	f	f	green	t	2026-05-02 13:13:52.757075+00	monthly
2	Farmer Box	صندوق الفلاح	La Boîte du Fermier	Complete monthly box for farmers with fertilizer, tips, and a customized crop plan	صندوق شهري يحتوي على 20 لتر من السماد السائل العضوي مع نصائح زراعية	Boîte mensuelle complète: 10kg d'engrais + conseils + plan cultural personnalisé	4500	20	t	t	f	amber	t	2026-05-02 13:13:52.757075+00	monthly
3	Expert Box	صندوق الخبير	La Boîte Expert	Premium monthly box for professionals with fertilizer, crop plan, and priority consultation	صندوق شهري يحتوي على 60 لتر من السماد السائل العضوي مع خطة زراعية مخصصة	Boîte mensuelle professionnelle: 20kg d'engrais + plan cultural + consultation prioritaire	8000	60	t	t	t	emerald	t	2026-05-02 13:13:52.757075+00	monthly
4	Green Box Annual	الصندوق الأخضر — سنوي	La Boîte Verte Annuelle	Annual subscription with 2 months free — organic worm castings and farming tips	اشتراك سنوي يحتوي على 30 كغ من السماد العضوي الصلب لمحصولك	Abonnement annuel 2 mois offerts: engrais lombricompost + conseils agricoles	25000	30	t	f	f	green	t	2026-05-10 12:13:36.784979+00	annual
5	Farmer Box Annual	صندوق الفلاح — سنوي	La Boîte du Fermier Annuelle	Annual subscription with 2 months free — complete box with fertilizer, tips, and crop plan	اشتراك سنوي يحتوي على 80 كغ من السماد العضوي الصلب مع نصائح زراعية	Abonnement annuel 2 mois offerts: 10kg d engrais + conseils + plan cultural	45000	80	t	t	f	amber	t	2026-05-10 12:13:36.784979+00	annual
6	Expert Box Annual	صندوق الخبير — سنوي	La Boîte Expert Annuelle	Annual subscription with 2 months free — premium box with fertilizer, crop plan and consultation	اشتراك سنوي يحتوي على 150 كغ من السماد العضوي الصلب مع خطة زراعية مخصصة	Abonnement annuel 2 mois offerts: 20kg engrais + plan cultural + consultation prioritaire	80000	150	t	t	t	emerald	t	2026-05-10 12:13:36.784979+00	annual
\.
...
11	6	wafa anifeg	4327635475247527	5	صندوق الفلاح — سنوي	45000	10	الطماطم	500 log	البليدة	active	2026-05-11 09:36:15.692037+00	2027-05-11 09:36:15.691+00		2026-05-11 09:36:15.692037+00	online	paid	01krb69xqe8dagv3d0cbs35wqz
12	6	wafa anifeg	4327635475247527	6	صندوق الخبير — سنوي	80000	20	الطماطم	zobra	أم البواقي	active	2026-05-11 09:41:00.50659+00	2027-05-11 09:41:00.506+00		2026-05-11 09:41:00.50659+00	online	paid	01krb6jm0yqs9xpendhkqfec23
13	4	bilal boussaadi	0657613345	6	صندوق الخبير — سنوي	80000	20	الفلفل	cite 3500	بسكرة	active	2026-05-11 11:19:09.174291+00	2027-05-11 11:19:09.173+00		2026-05-11 11:19:09.174291+00	online	paid	01krbc6at9vgh45d6x1c7bfy2m
14	9	adam anifak	6757557757657	1	الصندوق الأخضر	2500	5	الثوم	zobra lyce boudiaf	البليدة	pending_payment	2026-05-18 08:48:08.250775+00	2026-06-18 08:48:08.25+00		2026-05-18 08:48:08.250775+00	online	awaiting	01krx4av9jnj50c26ee977g81k
15	9	adam anifak	6757557757657	2	صندوق الفلاح	4500	10	البطيخ	zobra lycee boudiaf	البليدة	active	2026-05-18 08:54:01.794999+00	2026-06-18 08:54:01.794+00		2026-05-18 08:54:01.794999+00	online	paid	01krx4nmay460w48crmdq6pw4k
16	9	adam anifak	6757557757657	5	صندوق الفلاح — سنوي	45000	10	الجزر	hgfhfhgfhfhfhf	بشار	active	2026-05-18 08:59:10.274095+00	2027-05-18 08:59:10.273+00		2026-05-18 08:59:10.274095+00	online	paid	01krx4z1pe7rcqvfpwm8y3t9ev
\.
...
SELECT pg_catalog.setval('public.admin_notifications_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.admin_sessions_id_seq', 253, true);
...
--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.bio_waste_prices_id_seq', 7, true);


--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.bio_waste_purchases_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.course_enrollments_id_seq', 8, true);


--
-- Name: customer_sessions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.customer_sessions_id_seq', 67, true);
...
--
-- Name: delivery_sessions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: delivery_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.discount_codes_id_seq', 15, true);


--
-- Name: donor_sessions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.product_reviews_id_seq', 11, true);
...
--
-- Name: sensor_devices_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.subscription_deliveries_id_seq', 15, true);
...
--
-- Name: bio_waste_prices bio_waste_prices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_prices
    ADD CONSTRAINT bio_waste_prices_pkey PRIMARY KEY (id);


--
-- Name: bio_waste_prices bio_waste_prices_waste_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_prices
    ADD CONSTRAINT bio_waste_prices_waste_type_key UNIQUE (waste_type);


--
-- Name: bio_waste_purchases bio_waste_purchases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_purchases
    ADD CONSTRAINT bio_waste_purchases_pkey PRIMARY KEY (id);


--
-- Name: bio_waste_purchases bio_waste_purchases_request_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_purchases
    ADD CONSTRAINT bio_waste_purchases_request_code_key UNIQUE (request_code);
...
--
-- Name: delivery_sessions delivery_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: delivery_sessions delivery_sessions_token_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: delivery_users delivery_users_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: delivery_users delivery_users_username_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions donor_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: donor_sessions donor_sessions_token_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: donors donors_phone_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: donors donors_username_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches fertilizer_batches_batch_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fertilizer_batches fertilizer_batches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices sensor_devices_device_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sensor_devices sensor_devices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: waste_collections waste_collections_request_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: orders_tracking_number_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: bio_waste_purchases bio_waste_purchases_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bio_waste_purchases
    ADD CONSTRAINT bio_waste_purchases_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE SET NULL;
...
\unrestrict 9Fr0fKzUOQgpaWiSVUf1G1lUq3dVQR4dTnYAc02Y5ZKOD7VYHMXs6A5Sl8ZkGkr
