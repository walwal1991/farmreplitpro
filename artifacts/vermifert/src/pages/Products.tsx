...
export default function Products() {
  ...
  const filtered = useMemo(() => {
    ...
    return products.filter((p) => {
      if (category !== "all" && (p.category ?? "solid") !== category)
        return false;
            ...
            <Card className="border-border/60">
              <CardContent className="p-5 space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground">بحث</label>
                ...
                <div className="space-y-3">
                  <label className="text-sm font-medium text-muted-foreground block">النوع</label>
                  <div className="space-y-2">
                    {CATEGORIES.map((c) => {
                      ...
                      return (
                        ...
                        >
                          <span className={`text-sm ${checked ? "text-foreground font-bold" : "text-muted-foreground group-hover:text-foreground"}`}>
                            {c.label}
                          </span>
