...
\restrict JqDHIlsNAEg0AchngihebLpGZeKb3gL8M786WoVSPxNe5Eh9mo1IuTiBjydch5Y
...
--
-- Name: bio_waste_prices; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.bio_waste_prices OWNER TO postgres;

--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.bio_waste_prices_id_seq OWNER TO postgres;

--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.bio_waste_purchases OWNER TO postgres;

--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.bio_waste_purchases_id_seq OWNER TO postgres;

--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_prices id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: bio_waste_prices; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: bio_waste_purchases; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
25	كوكوبيت (ألياف جوز الهند) - كيس 5 كجم	وسيط زراعي طبيعي مستخرج من قشر جوز الهند. يُستخدم فراشاً للديدان أو خلطاً مع التربة لتحسين التهوية والاحتفاظ بالماء. شائع في البيوت المحمية والزراعة المائية (Hydroponie).	950	كيس	5	/api/img/coco-coir.png	34	t	2026-05-04 09:04:44.333813+00	substrate
...
27	تربة زراعية عضوية محسّنة - كيس 20 كجم	خلطة احترافية جاهزة للاستخدام: تربة طبيعية + سماد ديدان + كوكوبيت + بيرليت. pH محايد (6.5-7). مثالية للأصص والأحواض والخضروات المنزلية. مُعقَّمة وخالية من بذور الحشائش والآفات.	1800	كيس	20	/api/img/enriched-soil.png	21	t	2026-05-04 09:04:44.333813+00	substrate
...
SELECT pg_catalog.setval('public.admin_notifications_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.admin_sessions_id_seq', 220, true);
...
--
-- Name: bio_waste_prices_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.bio_waste_purchases_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.customer_sessions_id_seq', 63, true);
...
SELECT pg_catalog.setval('public.subscription_deliveries_id_seq', 13, true);
...
--
-- Name: bio_waste_prices bio_waste_prices_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_prices bio_waste_prices_waste_type_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases bio_waste_purchases_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases bio_waste_purchases_request_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bio_waste_purchases bio_waste_purchases_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict JqDHIlsNAEg0AchngihebLpGZeKb3gL8M786WoVSPxNe5Eh9mo1IuTiBjydch5Y
